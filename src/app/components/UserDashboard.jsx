    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-400">Create, track, and manage IT support tickets for all users and employees</p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <button
                  onClick={() => setActiveTab('create')}
                  className="flex items-center p-4 border border-gray-700 rounded-xl hover:border-emerald-500/50 hover:bg-emerald-500/10 transition-all duration-300 group"
                >
                  ...
                  <div className="text-left">
                    <p className="font-medium text-white">Create New Ticket</p>
                    <p className="text-sm text-gray-400">Report a new issue</p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="text-left">
                    <p className="font-medium text-white">View All Tickets</p>
                    <p className="text-sm text-gray-400">See all tickets for transparency</p>
                  </div>
                </button>

                <button className="flex items-center p-4 border border-gray-700 rounded-xl hover:border-cyan-500/50 hover:bg-cyan-500/10 transition-all duration-300 group">
