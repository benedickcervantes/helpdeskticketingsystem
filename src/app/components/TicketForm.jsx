...
import { ModernSpinner, SmartButton, StateTransitionLoader, IntelligentLoadingManager } from "./LoadingComponents";

import { useState, useEffect } from 'react';
import { db } from '../firebaseconfig';
import { collection, addDoc, serverTimestamp } from 'firebase/firestore';
import { useAuth } from '../contexts/AuthContext';
import { createAdminNewTicketNotification } from '../lib/notificationUtils';
...
const TicketForm = ({ onTicketCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try {
        await createAdminNewTicketNotification(
