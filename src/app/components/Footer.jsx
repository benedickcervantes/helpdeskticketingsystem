        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/user" className="text-slate-400 hover:text-emerald-400 transition-colors">Dashboard</a></li>
              <li><a href="/user" className="text-slate-400 hover:text-emerald-400 transition-colors">Create Ticket</a></li>
              <li><a href="/user" className="text-slate-400 hover:text-emerald-400 transition-colors">My Tickets</a></li>
              <li><a href="/auth" className="text-slate-400 hover:text-emerald-400 transition-colors">Login</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-slate-400 hover:text-emerald-400 transition-colors">Status Page</a></li>
            </ul>
          </div>
        </div>
