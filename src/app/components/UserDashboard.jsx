  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8">
      ...
      <div className="pt-4 sm:pt-6 pb-4 sm:pb-6">
        <h1 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-white">Support Hub</h1>
        <p className="mt-1 sm:mt-2 text-sm sm:text-base lg:text-lg text-gray-400">Create, track, and manage IT support tickets for all users and employees</p>
      </div>
