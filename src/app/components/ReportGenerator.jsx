...
const ReportGenerator = ({ tickets, users, metrics, healthStatus, departmentPerformance }) => {
  ...
  const formatOptions = [
    { id: 'pdf', name: 'PDF Document', icon: '📄', description: 'Professional PDF with charts' },
    { id: 'powerpoint', name: 'PowerPoint Presentation', icon: '📊', description: 'Executive presentation with visualizations' }
  ];
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Generate Executive Reports</h2>
        <p className="text-gray-600 mb-6">
          Select the type of report and format you need. All reports include comprehensive charts and visualizations 
      ...
      {/* Format Selection */}
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Select Report Format</h3>
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-semibold">{metrics?.totalTickets || 0}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span>Resolution Rate:</span>
                  <span className="font-semibold text-emerald-600">{metrics?.resolutionRate || 0}%</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span>Avg Resolution Time:</span>
                  <span className="font-semibold">{metrics?.avgResolutionTime || 0}h</span>
                </div>
              </div>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-2">Charts Included</h4>
              <div className="space-y-1">
                <div className="text-sm text-gray-600">• Ticket Volume Distribution</div>
                <div className="text-sm text-gray-600">• Status Distribution</div>
                <div className="text-sm text-gray-600">• Priority Breakdown</div>
                <div className="text-sm text-gray-600">• Department Performance</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex justify-center">
        <button
          ...
          className="px-8 py-4 bg-emerald-600 text-white rounded-xl font-semibold text-lg shadow-lg hover:bg-emerald-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
        >
          {isGenerating ? (
      ...
      <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-start">
            ...
            <div>
              <h4 className="font-medium text-blue-900">Robust Data Handling</h4>
              <p className="text-sm text-blue-700">Safe handling of undefined or missing data</p>
            </div>
          </div>
          <div className="flex items-start">
            <svg className="w-5 h-5 text-blue-600 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <h4 className="font-medium text-blue-900">Professional Formats</h4>
              <p className="text-sm text-blue-700">PDF and PowerPoint with embedded chart images</p>
            </div>
          </div>
          <div className="flex items-start">
            <svg className="w-5 h-5 text-blue-600 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <h4 className="font-medium text-blue-900">Error-Free Generation</h4>
              <p className="text-sm text-blue-700">Comprehensive validation prevents crashes</p>
            </div>
          </div>
          <div className="flex items-start">
            <svg className="w-5 h-5 text-blue-600 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <h4 className="font-medium text-blue-900">Ready for Presentation</h4>
              <p className="text-sm text-blue-700">Formatted for board meetings and executive reviews</p>
            </div>
          </div>
        </div>
      </div>
