...
const ProfileSettings = () => {
  ...
  const uploadPhoto = async (file) => {
    ...
    try {
      ...
      const user = await apiFetch('/api/v1/users/me/photo', { method: 'POST', body: form });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Update local state — merge photoURL so header/shell stay in sync
      const updatedProfile = {
        ...
        photoURL: photoURL || updated?.photoURL || updated?.photo_url || userProfile?.photoURL,
      };
