    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-6 pb-6">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white">Management Dashboard</h1>
          <p className="mt-2 text-base sm:text-lg text-gray-400">Comprehensive analytics and insights for executive decision making</p>
        </div>
